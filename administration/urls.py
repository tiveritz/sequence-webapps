...
urlpatterns = [
    ...
    path('steps/<str:id>/deletedecision/<str:step_id>/', steps.steps_delete_decision, name='steps-delete-decision'),
    ...
    path('steps/<str:id>/adddecisions/', steps.steps_add_decisions, name='steps-add-decisions'),
    path('steps/<str:id>/adddecisions/<str:step_id>/', steps.steps_add_decisions_confirm, name='steps-add-decisions-confirm'),
    ...
    path('steps/<str:id>/save-decision-order/', steps.save_decision_order, name='save_decision_order'),
